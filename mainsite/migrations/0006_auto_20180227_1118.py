# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-02-27 11:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainsite', '0005_auto_20180106_1223'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainsite.Article', verbose_name='评论所属文章')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='mainsite.Category', verbose_name='分类'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(blank=True, to='mainsite.Tag', verbose_name='标签集合'),
        ),
    ]
